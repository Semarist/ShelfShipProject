...
<div class="content-wrap">
    <div class="container isotope">
        ...
        <h1 class="mt-160 py-10 mb-100 text-center show-on-scroll" data-show-duration="500" data-show-distance="10">Our Books</h1>
        <ul class="nav justify-content-center isotope-options mb-60 show-on-scroll" data-show-duration="500">
            <li class="nav-item active show-on-scroll" data-show-duration="500" data-show-distance="10" data-show-delay="100">
                <a href="#" data-filter="all" class="nav-link">
                    <div class="nav-link-name">all books</div>
                </a>
            </li>
            <?php foreach ($categories as $category){ ?>
                <li class="nav-item show-on-scroll" data-show-duration="500" data-show-distance="10" data-show-delay="100">
                    <a href="#" data-filter="<?php echo $category['name'] ?>" class="nav-link">
                        <div class="nav-link-name"><?php echo $category['name'] ?></div>
                    </a>
                </li>
            <?php } ?>
        </ul>
        <div class="pt-30 show-on-scroll" data-show-duration="800">
            <div class="row gh-1 gv-1 isotope-grid">
                <?php foreach ($books as $book){ ?>
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 isotope-item" data-filters="<?php echo $book['category'] ?>" data-cursor-style="cursor-text" data-cursor-text="<?php echo $book['book_name'] ?>">
                        <a class="card card-portfolio card-overlay card-image-lg card-hover-zoom text-center" href="showBook.php?id=<?php echo $book['id'] ?>">
                            <span class="card-img">
...
<footer class="footer bg-dark text-white shape-parent overflow-hidden text-center pt-160 pb-60 mt-160">
    ...
    <div class="container pt-4">
        <ul class="nav align-items-center flex-column text-white mb-100">
            <li class="nav-item">
                <a href="mailto:hello@themebau.com?subject=Test%20Address%20Email" class="nav-link h2 mb-8 mb-md-30 d-none d-md-flex">hello@shelfShip.com</a>
                <a href="mailto:hello@themebau.com?subject=Test%20Address%20Email" class="nav-link h4 mb-8 mb-md-30 d-md-none">hello@shelfShip.com</a>
            </li>
            <li class="nav-item">
        ...
        <div class="footer-copyright mb-5">© 2023 - ShelfShip.</div>
    </div>
</footer>
<!-- START: Scripts -->
<!-- Object Fit Polyfill -->
