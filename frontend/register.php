                ...
                <div class="row justify-content-center text-white">
                    <div class="col-lg-10">
                        ...
                        <form action="../backend/register.php" method="post">
                            ...
                            <select id="user-type" name="user_type" class="custom-select">
                                <option value="0">User</option>
                                <option value="1">Library Owner</option>
                            </select>
                            <div class="row gh-1 gv-3 mt-30">
                                <div class="col-12 show-on-scroll" data-show-duration="500" data-show-distance="10" data-show-delay="!00">
                                    <input type="name" name="name" class="form-control form-control-lg form-control-white" placeholder="Your Name *" required>
                                </div>
                                <div class="col-12 col-md-6 show-on-scroll" data-show-duration="500" data-show-distance="10" data-show-delay="150">
                                    <input type="email" name="email" class="form-control form-control-lg form-control-white" placeholder="Your Email *" required>
                                </div>
                                <div class="col-12 col-md-6 show-on-scroll" data-show-duration="500" data-show-distance="10" data-show-delay="200">
                                    <input type="phone" name="phone" class="form-control form-control-lg form-control-white" placeholder="Your Phone *" required>
                                </div>
                                <div class="col-12 show-on-scroll" data-show-duration="500" data-show-distance="10" data-show-delay="250">
                                    <input type="password" name="password" class="form-control form-control-lg form-control-white" placeholder="Password *" required>
                                </div>
                                <div class="col-12 show-on-scroll" data-show-duration="500" data-show-distance="10" data-show-delay="!00">
                                    <input type="text" name="image" class="form-control form-control-lg form-control-white" placeholder="Image Name *" required>
                                </div>
                            </div>
