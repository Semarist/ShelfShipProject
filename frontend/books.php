...
<div class="content-wrap">
    <div class="container isotope">
        ...
        <h1 class="mt-160 py-10 mb-100 text-center show-on-scroll" data-show-duration="500" data-show-distance="10">Books</h1>
...
<footer class="footer bg-dark text-white shape-parent overflow-hidden text-center pt-160 pb-60 mt-160">
    ...
    <div class="container pt-4">
        <ul class="nav align-items-center flex-column text-white mb-100">
            <li class="nav-item">
                <a href="mailto:hello@shelfShip.com?subject=Test%20Address%20Email" class="nav-link h2 mb-8 mb-md-30 d-none d-md-flex">hello@shelfShip.com</a>
                <a href="mailto:hello@shelfShip.com?subject=Test%20Address%20Email" class="nav-link h4 mb-8 mb-md-30 d-md-none">hello@shelfShip.com</a>
            </li>
            <li class="nav-item">
