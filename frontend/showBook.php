    ...
    <div class="container mb-100">
        <div class="row gv-3 align-items-center mb-100 mb-lg-0">
            <div class="col-12 col-lg-6 show-on-scroll" data-show-duration="500" data-show-distance="20" data-show-origin="left" data-show-delay="250">
                <a href="assets/images/single-portfolio/style-2-1-1920-1080.jpg" class="gallery-item gallery-item-lg" data-fancybox="gallery-1" data-animation-effect="fade">
...
<!--                <p class="mb-0 lead font-weight-normal">Over 10 years of combined experience, and know a thing or two about designing websites and mobile apps.</p>-->
                <hr>
                <div class="row gh-1 gv-1">
                    <div class="col-auto col-sm-6">
                        <ul class="list-group list-group-gap borderless">
                            <li class="list-group-item"><span class="font-weight-medium mr-8">Price:</span>$ <?php echo $book['price'] ?></li>
                            <li class="list-group-item"><span class="font-weight-medium mr-8">Date:</span> <?php echo $book['date'] ?></li>
                            <li class="list-group-item"><span class="font-weight-medium mr-8">Genre:</span> <?php echo $book['category'] ?></li>
                        </ul>
                    </div>
                    <div class="col-auto col-sm-6">
                        <ul class="list-group list-group-gap borderless">
                            <li class="list-group-item"><span class="font-weight-medium mr-8">Author:</span> <?php echo $book['author'] ?></li>
                            <li class="list-group-item"><span class="font-weight-medium mr-8">Library:</span> <?php echo $book['library'] ?></li>
                        </ul>
                    </div>
                </div>
                <div class="text-center pt-60 mt-n8">
                    <a href="placeOrder.php?id=<?php echo $book['id'] ?>" style="color: white;background-color: #0d95e8" class="btn btn-with-ball">BUY</a>
                </div>
            </div>
...
<footer class="footer bg-dark text-white shape-parent overflow-hidden text-center pt-160 pb-60">
    ...
    <div class="container pt-4">
        <ul class="nav align-items-center flex-column text-white mb-100">
            <li class="nav-item">
                <a href="mailto:hello@themebau.com?subject=Test%20Address%20Email" class="nav-link h2 mb-8 mb-md-30 d-none d-md-flex">hello@themebau.com</a>
                <a href="mailto:hello@themebau.com?subject=Test%20Address%20Email" class="nav-link h4 mb-8 mb-md-30 d-md-none">hello@themebau.com</a>
            </li>
            <li class="nav-item">
                <a href="callto:+1202-358-0309" class="nav-link h4 mt-8 mt-md-0">+1 202-358-0309</a>
            </li>
        </ul>
        ...
        <div class="footer-copyright mb-5">© 2021 - Themebau by RunWebRun.</div>
    </div>
</footer>
<!-- START: Scripts -->
<!-- Object Fit Polyfill -->
