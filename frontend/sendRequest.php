            ...
            <div class="row justify-content-center text-dark">
                <div class="col-lg-10">
                    <form action="../backend/sendRequest.php" method="post">
                        <p class="lead font-weight-medium mb-30 mt-60 pt-9">Send Your Request!</p>
                        <div class="row gh-1 gv-3 mt-30">
                            <div class="col-12 show-on-scroll" data-show-duration="500" data-show-distance="10" data-show-delay="!00">
                                <input class="form-control form-control-lg form-control-dark" name="book_name" type="text" placeholder="Book Name" required>
                            </div>

                            <div class="col-12 show-on-scroll" data-show-duration="500" data-show-distance="10" data-show-delay="!00">
                                <input class="form-control form-control-lg form-control-dark" name="author" type="text" placeholder="Author" required>
                            </div>
                        </div>
