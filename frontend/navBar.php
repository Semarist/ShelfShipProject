<header class="navbar navbar-top navbar-expand-lg navbar-light">
    <div class="container">
        <a class="navbar-brand" href="home.php">
            <img width="120px" src="images/logo.svg" alt=""/>
            Shelf Ship
        </a>
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="nav-item navbar-dropdown">
                <a href="sendRequest.php" class="nav-link">
                    <span class="nav-link-name">Request</span>
                    <svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 9L5 5L1 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </a>
...
<!-- style 2 -->
<div class="navbar navbar-mobile navbar-mobile-style-2 navbar-light" id="navbar-mobile-style-2">
    ...
    <div class="navbar-head">
        <div class="container">
            <a class="navbar-brand" href="home.php">
                <img width="107" src="images/logo.svg" alt="">
            </a>
